						...
						<div class=" con-w3l">
							<div class="col-md-3 m-wthree">
								<div class="col-m">
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.jsp">Intel Core i9 9900K</a> 3.6GHz - 5GHz | 8 Cores - 16 Threads</h6>
										</div>
										<div class="mid-2">
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									Cache: 16 MB IntelÂ® Smart Cache <br />
									Bus Speed: 8 GT/s <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									Cache: 12 MB IntelÂ® Smart Cache <br />
									Bus Speed: 8 GT/s <br />
									Max Memory Size: 128 GB <br />
									Memory Types: DDR4-2666 <br />
									TDP: 95 W
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									Cache: 9 MB IntelÂ® Smart Cache <br />
									Bus Speed: 8 GT/s <br />
									Max Memory Size: 128 GB <br />
									Memory Types: DDR4-2666 <br />
									TDP: 65 W
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									Cache: 8 MB IntelÂ® Smart Cache <br />
									Bus Speed: 8 GT/s <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para">NVIDIAâ€™s newest flagship graphics card is a revolution in gaming realism and performance. Its powerful NVIDIA Turingâ„¢ GPU architecture, breakthrough technologies, and 11 GB of next-gen, ultra-fast GDDR6 memory make it the worldâ€™s ultimate gaming GPU. </p>
									<div class="price_single">
									...
									4K: Step up to the ultimate 4K gaming experience with GeForce RTX and enjoy todayâ€™s biggest games in amazing detail. <br />
									...
									Super Alloy Power II includes premium alloy chokes, solid polymer capacitors, and an array of high-current power stages to fuel Turingâ„¢â€™s cores. <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para">The GeForce RTXâ„¢ 2080 is powered by the all-new NVIDIA Turingâ„¢ architecture to give you incredible new levels of gaming realism, speed, power efficiency, and immersion. This is graphics reinvented.</p>
									<div class="price_single">
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para">The powerful new GeForce RTXâ„¢ 2070 takes advantage of the cutting-edge NVIDIA Turingâ„¢ architecture to immerse you in incredible realism and performance in the latest games. The future of gaming starts here.</p>
									<div class="price_single">
									...
									<p class="quick_desc">
									Features: <br />
									Powered by GeForceÂ® RTX 2070 SUPERâ„¢. <br />
									Integrated with 8GB GDDR6 256-bit memory interface. <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para">ROG Swift PG27UQ Gaming Monitor â€“ 27â€ 4K UHD (3840 x 2160), Overclockable 144Hz, G-SYNC HDR, Quantum-dot, IPS, Aura Sync.</p>
									<div class="price_single">
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para">34'' Class 21:9 UltraWideÂ® 5K2K Nano IPS LED Monitor with HDR 600 (34'' Diagonal).</p>
									<div class="price_single">
									...
									<h4 class="quick">Quick Overview:</h4>
									<p class="quick_desc">
									34" UltraWideÂ® Nano IPS Display. <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									With Quantum Dot technology, Samsungâ€™s QLED Gaming Monitor provides an extreme upgrade in your gaming experience. Quantum dot makes today's games appear more lifelike by delivering a billion shades of accurate color.
									...
									The CHG90 supports AMDâ€™s new Radeon FreeSyncâ„¢ 2 technology, which gives gamers a smooth HDR gaming experience with twice the perceivable brightness and color of that offered by the sRGB spectrum. <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									Go beyond the â€œstandardâ€ (1080p) gaming resolution. <br /> UltraWide QHD, (or 3440 x 1440), creates an entirely different kind of game experience. <br />
									Smooth, tear-free gaming is the norm with NVIDIAÂ® G-SYNCÂ® and a 120Hz* overclockable1 refresh rate. <br />
									</p>
									 <div class="add-to">
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<h4 class="quick">Quick Overview:</h4>
									<p class="quick_desc">
									Ready for AMD 3rd Gen Ryzenâ„¢ Threadripperâ„¢ Processors: Maximize connectivity and speed with up to five M.2 drives, USB3.2 Gen2x2 and AMD StoreMI. <br />
									...
									High-performance networking: Onboard AquantiaÂ® 10 Gbps Ethernet, Wi-Fi 6 (802.11ax) with MU-MIMO support, and GameFirst V technology. <br />
									...
									Industry-leading ROG audio: SupremeFX S1220 and ESSÂ® SABRE9018Q2C for enthusiast-grade audio performance, featuring Japanese capacitors. <br />
									DIY-friendly design: Pre-mounted I/O shield, ASUS SafeSlot, BIOS FlashBackâ„¢ and FlexKey. <br />
									</p>
									 <div class="add-to">
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<h4 class="quick">Quick Overview:</h4>
									<p class="quick_desc">
									Supports 9th / 8th Gen IntelÂ® Coreâ„¢ / PentiumÂ® Gold / CeleronÂ® processors for LGA 1151 socket. <br />
					...
					<div class="modal-content modal-info">
						...
						<div class="modal-body modal-spa">
								...
								<div class="col-md-7 span-1 ">
									...
									<p class="in-para">Own the Xbox One X Robot White Special Edition 1TB and get 4K Ultra HD Blu-rayâ„¢, 4K video streaming, premium audio, and an Xbox wireless controller.</p>
									<div class="price_single">
									...
									<p class="quick_desc">
									True 4K Gaming: <br />
									6 teraflops of graphical processing power and 4K Blu-rayâ„¢ provide more immersive gaming and entertainment. <br />
