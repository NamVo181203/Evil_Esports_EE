...
<div class="header">
		...
		<div class="container">
			...
			<div class="logo">
				<h1 ><a href="index.jsp"><b>T<br>H<br>E</b>KT Computer Store<span>Best Place For Building Your PC</span></a></h1>
			</div>
			<div class="head-t">
				<ul class="card">
									...
									<div class="row">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												...
												<!--<li><a href="gaminggear.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Cosmetics</a></li>
												<li><a href="gaminggear.jsp"><i class="fa fa-angle-right" aria-hidden="true"></i>Deo & Purfumes</a></li>-->
